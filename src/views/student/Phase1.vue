            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="table_title">
                        Smjer
                        <button v-if="$store.state.courses.length" class="btn btn-primary shadow-none" style="background-color:#232323; border-color:#232323;" @click="showFET">Izmjeni</button>
                    </td>
